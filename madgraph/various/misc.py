...
def vec_vec(V1,V2):
    """SS: Inner product between two vectors V1 and V2."""
    """SS: The expression is as (E^T*V1*E).(V2), where E is Levi civita."""
    inprod = '({}(3)*{}(6)-{}(4)*{}(5)-{}(5)*{}(4)+{}(6)*{}(3))'.format(V1,V2,V1,V2,V1,V2,V1,V2)
    return inprod
    
def vec_p(V,p):
    """SS: The function is the inner product between p_slashed and V."""
    """SS: Mathematical expression is (e^T*P_slashed*e).V, where e is the Levi-Civita. """
    inprod = "({}(3)*({}(0)-{}(3))-{}(4)*({}(1)+CI*{}(2))-{}(5)*({}(1)-CI*{}(2))+{}(6)*({}(0)+{}(3)))".format(V,p,p,V,p,p,V,p,p,V,p,p)
    return inprod
...
def postex_vertex_replacer(working_dir):
    ...
    vertex_list = [ 'LRV1_0.f', 'RLV1_0.f', 'LRV1_3.f', 'RLV1_3.f',\
        ...
        'LRV2_0.f', 'RLV2_0.f', 'LRV2_3.f', 'RLV2_3.f', 'LRV4_0.f', 'RLV4_0.f', 'LRV4_3.f', 'RLV4_3.f', 'VVV1_0.f', 'VVVV2_0.f']
